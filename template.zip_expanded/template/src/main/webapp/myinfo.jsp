...
이름 : ${mydata.get(0).MNAME}<br>
패스워드 : <input type="password" id="MPASS"value=""><br>
<!-- html : disabled를 적용 시 Back-end에게 값을 전달하는 방식도 안 되며, js에도 핸들링이 안 됨 -->
연락처 : <input type="text" id="MHP" value="${mydata.get(0).MHP}" maxlength="11" disabled>
<input type="button" value="연락처 수정" id="hpmodify">
<input type="button" value="휴대폰 인증" onclick="nice_info()"><br>
이메일 : <input type="text" id="MEMAIL" value="${mydata.get(0).MEMAIL}" disabled><br>
<input type="button" value="연락처 수정" id="mailmodify">
...
<script>
Kakao.init('239ac4bf209059f653e829f1684b4125');	//키발급된 번호
