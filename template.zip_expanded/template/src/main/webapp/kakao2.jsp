...
아이디 : <input type="text" name="mid" ><br> <!-- autocomplete="off" -->
패스워드 : <input type="password" name="mpass"><br>
<input type="submit" value="로그인">
<input type="checkbox" id="save_id"> 아이디 저장
</form>
<!-- 자동로그인 일 경우, 실제 로그인이 한번 되어야 활성화 된다
	 (백엔드에서 localStorage로 실행해 브라우저에 저장)
	 단순 아이디 저장 시, Front-end가 localStorage에 저장
-->
<br><br>
